...
import UnsupportedView from './Configurations/unsupported_views';
import ErrorView from './Configurations/error_views';
import DisconnectedView from './Configurations/disconnected_View';
import LoadingView from './Configurations/loading_views';
import renderActions from './Configurations/render_actions';
import getVideoInfo, { captureThumb } from './Configurations/get_video_info';
import {
...
} from './Configurations/custome_erros.js';
...
export default class VideoRecorder extends Component {
  ...
  handleContinueReplay = () => {
    this.replayVideo.play();
  }

  handeAcceptVideo = () => {
    this.props.onAcceptVideo()
    this.setState({
      isReplayingVideo: false
    })
  }
      ...
      return (
        <CameraView key='replay'>
          <Video
            ...
            onPause={() => this.setState({ isReplayPlaying: false })}
            onPlay={() => this.setState({ isReplayPlaying: true })}
          />
          {videoInput}
        </CameraView>
      )
    ...
    return (
      <Wrapper className={className}>
        ...
        {renderActions({
          ...
          onAcceptVideo: this.handeAcceptVideo,
          onContinueReplay: this.handleContinueReplay,
          onRecordAgain: this.handleStopReplaying,
        })}
      </Wrapper>
    )
  }
